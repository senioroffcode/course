    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(blank=True, choices=[(1, 'mentor'), (2, 'reception'), (3, 'accountant'), (4, 'director')], null=True)),
                ('phone', models.CharField(blank=True, max_length=555, null=True)),
            ],
            options={
                'verbose_name': 'user',
